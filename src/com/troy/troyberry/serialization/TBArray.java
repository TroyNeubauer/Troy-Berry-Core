...
public class TBArray extends TBBase {
	...
	public static TBArray Byte(String name, byte[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Short(String name, short[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Char(String name, char[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Integer(String name, int[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Long(String name, long[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Float(String name, float[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Double(String name, double[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Boolean(String name, boolean[] data) {
		TBArray array = new TBArray();
		array.setName(name);
	...
	public static TBArray Deserialize(byte[] data, int pointer) {
		byte containerType = data[pointer++];
		assert(containerType == CONTAINER_TYPE);
		
		TBArray result = new TBArray();
