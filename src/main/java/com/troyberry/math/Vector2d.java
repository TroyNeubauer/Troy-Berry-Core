...
public class Vector2d implements Interpolatable<Vector2d> {
	...
	@Override
	public Vector2d interpolate(Vector2d a, Vector2d b, double f, InterpolationType type) {
		return new Vector2d(type.interpolate(a.x, b.x, f), type.interpolate(a.y, b.y, f));
	}
